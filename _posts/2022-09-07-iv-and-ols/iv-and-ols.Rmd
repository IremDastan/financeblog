---
title: "How are Instrumental Variable (IV) and Ordinary Least Squares (OLS) Models Used?" 
description: |
  In this study, we will learn to read a table using the instrumental variable (IV) and ordinary least squares (OLS) methods.
author:
  - name: Irem Dastan
    url: {}
date: 2022-09-07
...
```{r}
library(ivreg);library(modelsummary);library(haven)
library(stargazer);options(scipen = 999)
```
...
```{r}
# Importing the data
Data_BHW_Replication <- read_dta("C:/Users/irem/Desktop/Data_BHW_Replication.dta")
```
...
```{r}
# In table 3 model 1;
# The dependent variable is all factories. 
# The independent variables are years of schooling 1849, Share of population <15, Share of population >60, County area, Share of population living in cities 1816.
...
# In table 3 model 2;
# The dependent variable is all factories. 
# The independent variables are years of schooling 1849, Share of population <15, Share of population >60, County area, Share of population living in cities 1816 and Looms per capita 1819.
...
# In table 3 model 3;
# The dependent variable is all factories. 
# The independent variables are years of schooling 1849, Share of population <15, Share of population >60, County area, Share of population living in cities 1816, Looms per capita 1819 and Steam engines in mining per capita 1849.
...
# In table 3 model 4;
# The dependent variable is all factories. 
# The independent variables are years of schooling 1849, Share of population <15, Share of population >60, County area, Share of population living in cities 1816, Looms per capita 1819, Steam engines in mining per capita 1849, Sheep per capita 1816 and Share of farm laborers in total population 1819.
...
```{r}
# In table 3 model 5;
# The dependent variable is years of schooling 1849. 
# The independent variables are school enrollment rate 1816, Share of population <15, Share of population >60, County area, Share of population living in cities 1816, Looms per capita 1819, Steam engines in mining per capita 1849, Sheep per capita 1816, Share of farm laborers in total population 1819, Public buildings per capita 1821, Paved streets 1815 (dummy) and Tonnage of ships per capita 1819.
...
# In table 3 model 6;
# The dependent variable is all factories. 
# The independent variables are Years of schooling 1849, Share of population <15, Share of population >60, County area, Share of population living in cities 1816, Looms per capita 1819, Steam engines in mining per capita 1849, Sheep per capita 1816, Share of farm laborers in total population 1819, Public buildings per capita 1821, Paved streets 1815 (dummy) and Tonnage of ships per capita 1819.
...
# In table 3 model 7;
# The dependent variable is all except metal and textiles. 
# The independent variables are Years of schooling 1849, Share of population <15, Share of population >60, County area, Share of population living in cities 1816, Looms per capita 1819, Steam engines in mining per capita 1849, Sheep per capita 1816, Share of farm laborers in total population 1819, Public buildings per capita 1821, Paved streets 1815 (dummy) and Tonnage of ships per capita 1819.
...
# In table 3 model 8;
# The dependent variable is metal factories. 
# The independent variables are Years of schooling 1849, Share of population <15, Share of population >60, County area, Share of population living in cities 1816, Looms per capita 1819, Steam engines in mining per capita 1849, Sheep per capita 1816, Share of farm laborers in total population 1819, Public buildings per capita 1821, Paved streets 1815 (dummy) and Tonnage of ships per capita 1819.
